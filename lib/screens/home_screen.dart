                ...
                children: [
                  ...
                  GridView.count(
                    ...
                    children: [
                      ...
                      // 3. القرآن الكريم (الانتقال لصفحتك المحددة)
                      _buildGridItem(context, "القرآن الكريم", Icons.menu_book_rounded, Colors.emeraldAccent, () {
                        Navigator.push(context, MaterialPageRoute(builder: (_) => const YasserDossariPage()));
                      }),
